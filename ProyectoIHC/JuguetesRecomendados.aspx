<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JuguetesRecomendados.aspx.cs" Inherits="ProyectoIHC.JuguetesRecomendados" %>
	                ...
	                <div class="row">
                        ...
                        <form id="form1" runat="server">
	                        <div class="span9">
                                ...
                                -->
	                            <h3>Juguetes Recomendados<small id="numArticulos" runat="server" class="pull-right"></small></h3>	
	                            <hr class="soft"/>
                                    <div class="span5 navMenu">
                                            <asp:HyperLink runat="server" ID="hpvAnt1" text="&lsaquo;" NavigateUrl="~/JuguetesRecomendados.aspx?page=1"/>
                                            <asp:HyperLink runat="server" ID="HyperLink2" text="1" NavigateUrl="~/JuguetesRecomendados.aspx?page=1"/>
                                            <asp:HyperLink runat="server" ID="HyperLink3" text="2" NavigateUrl="~/JuguetesRecomendados.aspx?page=2"/>
                                            <asp:HyperLink runat="server" ID="HyperLink4" text="3" NavigateUrl="~/JuguetesRecomendados.aspx?page=3"/> 
                                            <asp:HyperLink runat="server" ID="HyperLink5" text="4" NavigateUrl="~/JuguetesRecomendados.aspx?page=4"/>
                                            <asp:HyperLink runat="server" ID="HyperLink6" text="5" NavigateUrl="~/JuguetesRecomendados.aspx?page=5"/>   
                                            <asp:HyperLink runat="server" ID="hpvDes1" text="&rsaquo;" NavigateUrl="~/JuguetesRecomendados.aspx?page=5"/>
                                    </div>
                                                ...
                                                <li class="span3">
				                                    ...
				                                    <div class="caption">
				                                        ...
				                                        <h4 style="text-align:center">
                                                            ...
                                                            <a class="btn btn-primary" href="#">$<%# Eval("precio") %></a></h4>
				                                    </div>
                                ...
                                <div class="span5 navMenu">
                                    <asp:HyperLink runat="server" ID="hpvAnt2" text="&lsaquo;" NavigateUrl="~/JuguetesRecomendados.aspx?page=1"/>
                                    <asp:HyperLink runat="server" ID="HyperLink7" text="1" NavigateUrl="~/JuguetesRecomendados.aspx?page=1"/>
                                    <asp:HyperLink runat="server" ID="HyperLink8" text="2" NavigateUrl="~/JuguetesRecomendados.aspx?page=2"/>
                                    <asp:HyperLink runat="server" ID="HyperLink9" text="3" NavigateUrl="~/JuguetesRecomendados.aspx?page=3"/> 
                                    <asp:HyperLink runat="server" ID="HyperLink10" text="4" NavigateUrl="~/JuguetesRecomendados.aspx?page=4"/>
                                    <asp:HyperLink runat="server" ID="HyperLink11" text="5" NavigateUrl="~/JuguetesRecomendados.aspx?page=5"/>
                                    <asp:HyperLink runat="server" ID="hpvDes2" text="&rsaquo;" NavigateUrl="~/JuguetesRecomendados.aspx?page=5"/>
                                </div>
			                    <br class="clr"/>
                            </div>
                        </form>
