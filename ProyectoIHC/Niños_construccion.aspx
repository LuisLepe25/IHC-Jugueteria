<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Niños_construccion.aspx.cs" Inherits="ProyectoIHC.Niños_construccion" %>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Construccion para niños</li>
    </ul>
	<h3> Construccion para niños <small class="pull-right"> 25 productos ahora disponible </small></h3>	
	<hr class="soft"/>
	<hr class="soft"/>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<div class="row">	  
			<div class="span2">
                <img src="../../../../Ima/Niños2/Construccion/Bloques Magnéticos 130 Piezas.jpg" alt=""/>
			</div>
			<div class="span4">
				...
				<p>
                    Diviértete formando lo que imagines con estos bloques magnéticos.
                    Contiene 130 piezas.
		...
		<div class="row">	  
			<div class="span2">
                <img src="../../../../Ima/Niños2/Construccion/Construye tu Camión Excavadora.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Juego de construcción con el que pasarás momentos muy divertidos constuyendo esta excavadora. Incluye 287 piezas.
		...
		<div class="row">	  
			<div class="span2">
              <img src="../../../../Ima/Niños2/Construccion/Construye tu Todoterreno.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Demuestra tu habilidad y destreza para lograr construir este fantástico todoterreno. Con un total de 357 piezas.
		...
		<div class="row">	  
			<div class="span2">
                <img src="../../../../Ima/Niños2/Construccion/Juguettos Construcción Policía Marítima.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Construye esta súper patrulla policial con las 418 piezas que incluye y 4 figuras para divertirte salvando situaciones peligrosas y capturando a los ladrones.
		...
		<div class="row">	  
			<div class="span2">
                <img src="../../../../Ima/Niños2/Construccion/LEGO Arquitecture Fontana de Trevi 21020.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Recrea uno de los monumentos más característicos de Roma: la Fontana de Trevi
                    Construye la Fontana de Trevi con esta reproducción de la preciosa estructura barroca erigida en el corazón de Roma, perteneciente a la serie Monumental de LEGO Architecture
		...
		<div class="row">	  
			<div class="span2">
               <img src="../../../../Ima/Niños2/Construccion/LEGO Classic Caja de Ladrillos Creativos Mediana 10696.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Crea tus propios vehículos LEGO con LEGO Classic. Fomenta el juego de construcción sin restricciones e invita a construir vehículos en diferentes colores. Para muchas horas de diversión.
                    484 piezas.
