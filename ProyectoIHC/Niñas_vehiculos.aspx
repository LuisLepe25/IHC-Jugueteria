<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Niñas_vehiculos.aspx.cs" Inherits="ProyectoIHC.Catalogo_niños" %>
...
<!-- Sidebar end=============================================== -->
	...
	<h3> Vehiculos<small class="pull-right"> Mas de 20 articulos </small></h3>	
	<hr class="soft"/>
	<p>
		Por que las chicas tambien necesitamos velocidad, encuentra aqui muchos productos sabre vehiculos femenil.
	<hr class="soft"/>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<div class="row">	  
			<div class="span2">
                <img src="Ima/Niñas%20bellas/carritos/buu.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora disponible</h3>				
				<hr class="soft"/>
				<h5>Wonder Woman - Jet Invisible </h5>
				<p>La muñeca de acción de la Mujer Maravilla de la Edad Moderna llevaba un traje de jet-setting y se basó en su aparición en la Guía de Estilo DC Super Hero Girls, pantalones cortos animados, sitio web y otros multimedia con traje moldeado con rasgos faciales impresos y detalles de traje. 
				</p>
		...
		<div class="row">	  
			<div class="span2">
				<img src="Ima/Niñas%20bellas/carritos/caballo.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora disponible</h3>				
				<hr class="soft"/>
				...
				<p>
				Esta Barbie Dreamtopia Villa Caramero carruaje y unicornio es un dulce paseo para Barbie princesa muñeca. ¡Abre la puerta para dejarla entrar y montar en estilo real! Inspirado por una fresa, el carruaje es tan bonito creando un ambiente de magia lleno de colores.
		...
		<div class="row">	  
			<div class="span2">
                <img src="Ima/Niñas%20bellas/carritos/chida.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora disponible</h3>				
				<hr class="soft"/>
				...
				<p>
				Un conjunto de juego que incluye un dron con una muñeca, el mando de control y un cable. En sus aventuras entre las estrellas, Barbie viaja a través de la galaxia sobre su tabla de surf espacial. Gracias a este dron de control remoto, Barbie puede despegar fácilmente y volar, cambiar de dirección o modificar su altitud. Su manejo es muy sencillo y, gracias a los botones del mando de control, también permite ejecutar acciones programadas.
				</p>
				<a class="btn btn-small pull-right" href="product_details.html">Ver detalles</a>
				<br class="clr"/>
			</div>
		...
		<div class="row">	  
			<div class="span2">
                <img src="Ima/Niñas%20bellas/carritos/hi.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora disponible</h3>				
				<hr class="soft"/>
				...
				<p>
				Ladybug acude en su moto para ayudar a liberar a Paris de sus enemigos. Con figuras de Ladybug y Tikki. ¡Mira como se mueve Tikki cuando se desplaza sobre la moto!
				</p>
		...
		<div class="row">	  
			<div class="span2">
                <img src="Ima/Niñas%20bellas/carritos/gobierno.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora disponible</h3>				
				<hr class="soft"/>
				<h5>My Little Pony - Cheese Sandwich</h5>
				<p>
				</p>
				<a class="btn btn-small pull-right" href="product_details.html">Ver detalles </a>
				<br class="clr"/>
		...
		<div class="row">	  
			<div class="span2">
                <img src="Ima/Niñas%20bellas/carritos/jet.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora disponible</h3>				
				<hr class="soft"/>
