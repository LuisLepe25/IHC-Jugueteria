<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Niños_Autopistas.aspx.cs" Inherits="ProyectoIHC.Niños_Autopistas" %>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Autopistas para niños</li>
    </ul>
	<h3> Autopistas para niños <small class="pull-right"> 25 productos ahora disponible </small></h3>	
	<hr class="soft"/>
	<hr class="soft"/>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<div class="row">	  
			<div class="span2">
               <img src="../../../../Ima/Niños2/Autopistas/2 Super Truck con Accesorios.jpg" alt=""/>
			</div>
			<div class="span4">
				...
				<p>
                    Un juego súper divertido. Pasa por todos los obstáculos con estos dos súper truck.
				</p>
		...
		<div class="row">	  
			<div class="span2">
               <img src="../../../../Ima/Niños2/Autopistas/4R Parking 2 Plantas Restaurante.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Tamaños: 35x47x35
                    ¡Baja la rampa hasta el túnel de lavado! Ahora a repostar en la gasolinera. ¡Este garaje tiene de todo! Incluye 6 coches.
		...
		<div class="row">	  
			<div class="span2">
               <img src="../../../../Ima/Niños2/Autopistas/Blaze Pista Estadio Monster Dome.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
		...
		<div class="row">	  
			<div class="span2">
               <img src="../../../../Ima/Niños2/Autopistas/Cars Movie Pistas Historia Varios Modelos.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Diversión asegurada con estas pistas de Cars.
                    Incluyen un vehículo cada una.
                    Hay dos modelos diferentes, no sabemos cuál recibirás, es sorpresa. Si deseas uno en concreto, contacta con nosotros después de hacer el pedido.
		...
		<div class="row">	  
			<div class="span2">
              <img src="../../../../Ima/Niños2/Autopistas/Garage de la copa pistón Cars.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				<h5></h5>
				<p>
                    ¡Corre a toda velocidad hacia el Garage de la copa pistón para divertirte al máximo con Cars! Tiene dos niveles, elevador que funciona, parada de servicio de pits, áreas múltiples de juego y un Rayo McQueen de metal a escala 1:55, para recrear toda la acción de la competencia. Y eso no es todo, el set copa pistón se conecta a otros de la historia para que la emoción de película no se detenga
		...
		<div class="row">	  
			<div class="span2">
              <img src="../../../../Ima/Niños2/Autopistas/Hot Wheels Carrera Súper Explosiva.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3>Ahora Disponible</h3>				
				<hr class="soft"/>
				...
				<p>
                    Con esta pista podrás competir con un amigo, ¡será el vencedor aquél que tire las figuras a mayor velocidad! ¡Ve correr a tus autos como nunca antes y demuestra por qué eres el mejor!
